(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_50811ff6._.js", {
...
function ThemeProvider({ children }) {
    ...
    const [theme, setTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ThemeProvider.useState": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                const storedTheme = localStorage.getItem("swiftcart-theme");
                if (storedTheme) {
                    return storedTheme;
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            // Ensure resolvedTheme is set on initial mount if theme is system
            if ("object" !== 'undefined' && theme === 'system') {
...
_s(ThemeProvider, "RT97svTPHVPBz/Z5N2/hjN/RzuI=");
_c = ThemeProvider;
function useTheme() {
    _s1();
...
function AuthProvider({ children }) {
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Check auth status on mount
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            // Check for auth token in cookie on initial load
            const token = ("TURBOPACK compile-time truthy", 1) ? document.cookie.split('; ').find({
                "AuthProvider.useEffect": (row)=>row.startsWith(`${AUTH_COOKIE_NAME}=`)
            }["AuthProvider.useEffect"]) : ("TURBOPACK unreachable", undefined);
            if (token) {
                // In a real app, verify token with backend and fetch user data
                // For simulation, assume token means authenticated
                const dummyUser = {
                    id: "1",
                    name: "Demo User",
    ...
    const login = async (userData, _otp)=>{
        ...
        setUser(userData);
        setIsAuthenticated(true);
        // Set a dummy auth token cookie
        if ("TURBOPACK compile-time truthy", 1) {
            document.cookie = `${AUTH_COOKIE_NAME}=dummy-token; path=/; max-age=${60 * 60 * 24 * 7}`; // 7 days
        }
        setIsLoading(false);
...
//# sourceMappingURL=src_50811ff6._.js.map